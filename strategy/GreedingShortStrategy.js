...
class GreedingShortStrategy extends BaseStrategy {
    ...
    OnTick(tick) {
        ...
        if (this.lastTick && this.lastTick.lastPrice > tick.lastPrice) {
            ...
            if (availablesSum >= 1) {
                console.log(tick.clientName, tick.symbol, price, 1, Direction.Sell, OpenCloseFlagType.Open, 1, this.total)
...
module.exports = GreedingShortStrategy;
