...
class FeeIIBuyStrategy extends BaseStrategy {
    ...
    _profitLong(tick) {
        ...
        if (position !== undefined) {
            ...
            let num = todayLongPositions - unFinishOrderList.length;
            console.log("num: " + num + " todayLongPositions: " + todayLongPositions + " unFinishOrderList.length: " + unFinishOrderList.length);
            ...
            if (tick.lastPrice > longPositionAveragePrice && this.lastOpenPrice && tick.lastPrice > this.lastOpenPrice) {
                if (todayLongPositions > 0 && this.lastSignal > -2) {
...
module.exports = FeeIIBuyStrategy;
