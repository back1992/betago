...
class FeeLimitSellStrategy extends BaseStrategy {
    ...
    OnClosedBar(closedBar) {
        ...
        if (this.signal >= 2) {
            ...
            this.stopPrice = closedBar.highPrice;
        } else {
            this.direction = null
        }
    }
    ...
    _closeProfitShort(tick) {
        ...
        if (unFinishOrderList.length === 0) {
            ...
            if (position !== undefined) {
                ...
                if (price < shortPositionAveragePrice - priceTick) {
...
module.exports = FeeLimitSellStrategy;
